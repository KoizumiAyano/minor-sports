...
import MinorSportsBulletinBoardPage from './pages/MinorSportsBulletinBoardPage.jsx';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/minor-sports/:sportsId/bulletin-board" element={<MinorSportsBulletinBoardPage />} />
